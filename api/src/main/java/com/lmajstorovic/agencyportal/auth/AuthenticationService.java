...
public class AuthenticationService {
    ...
    public void register(RegisterRequest request) {
        ...
        Rank rank = rankRepository.findRankByName("Agent I")
            .orElseThrow(() -> new IllegalArgumentException("Rank not found: Agent I"));
    ...
    public void updatePassword(
        ...
        if (user.isPresent()) {
            ...
            if (password == null || password.length() < 8) {
                ...
                throw new IllegalStateException("New password can not be the same" +
                    " as the old password");
            } else {
